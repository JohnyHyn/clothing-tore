...
const docTemplate = `{
    ...
    "paths": {
        "/forgot-password": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message, token (for demo)",
                        "schema": {
                            "type": "object",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.ShippingHistory"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateShippingStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/shippings/track": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Tracking code is required",
                        "schema": {
                            "type": "string"
                        }
                    },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateTrackingCodeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/vouchers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Show only active vouchers",
                        "name": "active_only",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "handler.UpdateShippingStatusRequest": {
            "type": "object",
            "properties": {
                "location": {
                    "type": "string",
        ...
        "handler.UpdateTrackingCodeRequest": {
            "type": "object",
            "properties": {
                "tracking_code": {
                    "type": "string",
        ...
        "model.Shipping": {
            ...
            "properties": {
                ...
                "method": {
                    "description": "\"standard\", \"express\", \"same_day\"",
                    "type": "string"
                },
                "note": {
                    "description": "Ghi chú",
                ...
                "provider": {
                    "description": "\"ghn\", \"ghtk\", \"viettel_post\"",
                    "type": "string"
                },
                "receiver_name": {
                ...
                "status": {
                    "description": "\"pending\", \"picked_up\", \"in_transit\", \"delivered\", \"failed\"",
                    "type": "string"
                },
                "tracking_code": {
        ...
        "model.Voucher": {
            ...
            "properties": {
                "code": {
                    "description": "Mã voucher, e.g., \"SUMMER2026\"",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "is_active": {
                    "description": "Còn hoạt động không",
                    "type": "boolean"
                },
                "max_discount": {
                ...
                "type": {
                    "description": "\"percentage\" hoặc \"fixed\"",
                    "type": "string"
                },
                "usage_limit": {
                ...
                "used_count": {
                    "description": "Đã dùng bao nhiêu lần",
                    "type": "integer"
                },
                "value": {
